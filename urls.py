...
https://drive.google.com/file/d/1EdBX-iNkXMU0Qea9bDNoEw29hYgwtwKg/view?usp=drive_link
https://drive.google.com/file/d/1Yzm8bRXY-ag2oIqgzTofgf66ZLAhSAEj/view?usp=drive_link
https://drive.google.com/file/d/15v7neYO5cEGNFvOBsJix6cLZpahuNTIa/view?usp=drive_link
https://drive.google.com/file/d/1AY3JiEQh7akvlBzSdYHTZ2soPxpH_wz1/view?usp=drive_link
https://drive.google.com/file/d/1WRKoEy1vkmKsvClZb9jFOaXHZ2cm5a9s/view?usp=drive_link
https://drive.google.com/file/d/1KIkKtcne-w6ft06Y2P8wUUDVb3xBGdyl/view?usp=drive_link
https://drive.google.com/file/d/1xs1b_WQQugxDGUEqHnjWDtKePvydFfqN/view?usp=drive_link
...
"""
p = re.compile(r'1[a-zA-Z0-9_-]{32}')
links = p.findall(text)
unique_links = list(dict.fromkeys(links))
for i in unique_links:
    print('"' + 'https://lh3.googleusercontent.com/d/' + i + '",')
