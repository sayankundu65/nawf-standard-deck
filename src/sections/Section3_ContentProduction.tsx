...
export function Section3ContentProduction() {
  const categories = [
    ...
    { title: "VIDEO [16:9]", items: ["AIRLINE (AKASA)", "FMCG (CORDON, LICK IT YOUR WAY, FARMLEY)"] },
    { title: "VIDEO [9:16]", items: ["PERIPHERALS (ASUS GAMING SETUP)", "FMCG (LAHORI, FARMLEY)", "LIFESTYLE APPLIANCES (DYSON)", "ACCESSORIES (LENSKART)"] },
